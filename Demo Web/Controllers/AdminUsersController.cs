...
namespace Demo_Web.Controllers
{
    public class AdminUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserName,UserPass")] AdminUser adminUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserName,UserPass")] AdminUser adminUser)
        {
            if (ModelState.IsValid)
            {
